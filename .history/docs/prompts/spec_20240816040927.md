...
All the locations of every segments must also be saved in the database. So the user can view the locations of the segments and there should be an endpoint to save l

...
So firstly I added to the json file how `add` would look like for the app by firstly adding the endpoint and the method. After the endpoint and method I added the headers and then I added the body of the request.
The 
...
```json
{
    ...
    // Add an new expense for the user
    "add": {
    ...
    // Edit an expense linked to the user
    "edit": {

    },
    // Delete an user's expense
    "delete": {

    },
    // View a user's expense
    "view": {

...
## Trip Management
First it is important to know that the gps logs are there for any part of the app the reference when needed. For as long as the app is open the gps coordinates are log 
